(function (globalScope) {
    ...
    function buildHVACAnalysisPrompt(summary) {
        return [
            ...
            `- "periodBreakdown" is the most important field: it shows how the system behaved over time, bucketed ${summary && summary.breakdownGranularity === 'daily' ? 'by DAY (because the analyzed span is short)' : 'by WEEK'}. Each entry is labeled with "${summary && summary.breakdownGranularity === 'daily' ? 'dayStart' : 'weekStart'}". ALWAYS analyze trends over time here before drawing conclusions.`,
